...
var config = {
	name: 'fcRetail',
	version: 'v1.0.0',
	oss: `http://image.fcyun.com/fcRetail/`,
	replaceFileArr: [],
	projSrc: `E:/Workspace/FCRetail/retail-pend/retail-pend-admin/src/main/resources`
};
...
gulp.task('_html', ['_js'], function(done) {
	return gulp.src(['./dist/rev/**/*.json', './dist/templates/**/*.html'])
		...
		//替换css 里面的路径
		.pipe(gulpif('*.css', replace('/static', '/fcRetail/' + config.version)))
		//替换html 里面的路径
